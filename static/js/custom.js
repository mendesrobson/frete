...
$.ajax({
    url : "https://sonasystem.com.br/apis/v1/regioes/buscarnome",
    type : 'get',
    beforeSend : function(){
         console.log("ENVIANDO...")
    }
...
.done(function(msg){
    if(msg.status == 200){
        for (var i = 0; i < msg.dados.length; i++) {
            bairro.push(msg.dados[i].Bairro);
          }
    }
})
.fail(function(jqXHR, textStatus, msg){
...
$.ajax({
    url : "https://sonasystem.com.br/apis/v1/vendedores/buscar",
    type : 'get',
    beforeSend : function(){
         console.log("ENVIANDO...")
    }
...
.done(function(msg){
    if(msg.status == 200){
        for (var i = 0; i < msg.dados.length; i++) {
            vendedor.push(msg.dados[i].NomeVendedor);
          }
    }
})
.fail(function(jqXHR, textStatus, msg){
...
autocomplete(document.getElementById("Bairro"), bairro);
autocomplete(document.getElementById("Vendedor"), vendedor);